...
- Set the path of dataroot_GT, dataroot_LQ and pretrain_model_G in the yml file. In this case, related to train.yml, dataroot_LQ is path_to\DIV2K_train_LR_bicubic\X4_sub_120 and dataroot_GT is path_to\DIV2K_train_HR_sub_480.
